...
@shopping
Feature: As a user I would like to buy new clothes from automationexercise.com - User is already successfully logged
#--------------------------------------------------------------------------------#
# [UserStory] https://tracker.FAKE.com/jira/browse/AUTOMATION_PRACTICE-666       #
#--------------------------------------------------------------------------------#

  Background: Navigate to automationexercise.com website
